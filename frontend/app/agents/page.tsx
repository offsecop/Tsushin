          ...
          <div className="border-b border-tsushin-border/50">
            <nav className="flex">
              ...
              >
                ...
                {pathname === '/agents/custom-skills' && (
                  <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-12 h-0.5 rounded-full bg-gradient-to-r from-violet-500 to-purple-400" />
                )}
              </Link>
            </nav>
          </div>
